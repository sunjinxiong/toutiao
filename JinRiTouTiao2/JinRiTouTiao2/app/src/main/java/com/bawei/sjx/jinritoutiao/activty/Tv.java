...
import com.bawei.sjx.jinritoutiao.Herper.OtherAdapter;
import com.bawei.sjx.jinritoutiao.bean.Path;
import com.bawei.sjx.jinritoutiao.view.MyGridView;
import com.bawei.sjx.jinritoutiao.R;
import java.util.ArrayList;
import java.util.List;

public class Tv extends AppCompatActivity implements OnItemClickListener {
    private MyGridView mUserGv, mOtherGv;
    private List<Path> mUserList = new ArrayList<Path>();
    private List<Path> mOtherList = new ArrayList<Path>();
    private OtherAdapter mUserAdapter, mOtherAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       setContentView(R.layout.gridview);
        mUserList=Main2Activity.listtab;
        mOtherList= Main2Activity.lview;
        initView();
    }
     ...
     * @param clickGridView
     */
    private void MoveAnim(View moveView, int[] startLocation, int[] endLocation, final Path moveChannel,
        ...
        switch (parent.getId()) {
            case R.id.userGridView:
                ...
                if (position != 0 && position != 1) {
                    ...
                    if (moveImageView != null) {
                        ...
                        final Path channel = ((OtherAdapter) parent.getAdapter()).getItem(position);//获取点击的频道内容
            ...
            case R.id.otherGridView:
                ...
                if (moveImageView != null) {
                    ...
                    final int[] startLocation = new int[2];
                    newTextView.getLocationInWindow(startLocation);
                    final Path channel = ((OtherAdapter) parent.getAdapter()).getItem(position);
